...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{ route('admin.info') }}">首页</a> &raquo; <a href="{{ route('admin.category.index') }}">分类管理</a> &raquo; 添加分类
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>分类标题：</th>
                        <td>
                            <input type="text" class="lg" name="ctitle">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <textarea name="ckeywords"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>描述：</th>
