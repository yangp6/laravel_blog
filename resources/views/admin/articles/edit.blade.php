...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{ route('admin.info') }}">首页</a> &raquo; <a href="{{ route('admin.article.index') }}">文章管理</a> &raquo; 修改文章
    </div>
    <!--面包屑导航 结束-->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cid">
                                @foreach($cate as $v)
                                    <option value="{{ $v->id }}" @if($data->cid == $v->id) selected @endif>{{ $v->cname }}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>编辑者：</th>
                        <td>
                            <input type="text" class="sm" name="editor" value="{{ $data->editor }}">
                        </td>
                    </tr>
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text"  size="50"   name="thumb" value="{{ $data->thumb }}">
                    ...
                    <tr>
                        <th></th>
                        <td id="art_thumb_img">
                            <img src="{{ $data->thumb }}" style="max-width: 300px; max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                    ...
                    <tr>
                        <th>文章内容：</th>
                        <td>
                            <script id="editor" name="content" type="text/plain" style="width:860px;height:500px;">{!! $data->content  !!}</script>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
